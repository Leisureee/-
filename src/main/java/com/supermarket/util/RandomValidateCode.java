...
public class RandomValidateCode {
    ...
    private final int height = 33;// 图片高
    ...
    private String drawString(Graphics g, String randomString, int i) {
        ...
        g.setColor(new Color(this.random.nextInt(155),
                this.random.nextInt(123), this.random.nextInt(176)));
        ...
        g.drawString(rand, (this.width / this.stringNum - 14) * i,
                this.height - 7);
        return randomString;
    }
    ...
    private Font getFont() {
        return new Font("Times New Roman", Font.BOLD, this.fontSize);
    }
