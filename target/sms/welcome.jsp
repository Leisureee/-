...
<%
    ...
    String localURL = basePath + request.getServletPath();
        ...
        <div class="col-md-12">
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark static-top">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="navbar-nav">
                        <li class="nav-item"><a class="nav-link" href="UserController?action=exit">安全登出</a></li>
            ...
            <div class="row">
                    ...
                    <div id="card-1">
                        <div class="card">
                            <div class="card-header">
                                <a class="card-link" data-toggle="collapse" data-parent="#card-1"
                                   href="#card-element-1">商品管理</a>
                            </div>
                            <div id="card-element-1" class="collapse">
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" href="GoodsController?action=show">查看所有商品信息</a>
                                </div>
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" data-toggle="modal" data-target="#addGoods" href="">新添一条商品记录</a>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="collapsed card-link" data-toggle="collapse" data-parent="#card-1"
                                   href="#card-element-2">员工管理</a>
                            </div>
                            <div id="card-element-2" class="collapse">
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" href="EmployeeController?action=show">查看所有员工信息</a>
                                </div>
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" data-toggle="modal" data-target="#addEmployee"
                                       href="#">新添一条员工记录</a>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <a class="collapsed card-link" data-toggle="collapse" data-parent="#card-1"
                                   href="#card-element-3">会员管理</a>
                            </div>
                            <div id="card-element-3" class="collapse">
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" href="VipController?action=show">查看所有会员信息</a>
                                </div>
                                <div class="card-body card-block">
                                    <a class="collapsed card-link" data-toggle="modal" data-target="#addVip" href="#">新添一条会员记录</a>
                                </div>
                ...
                <div class="col-md-10">
                    ...
                    <%} else if (request.getAttribute("employeeList") != null) {%>
                    <jsp:include page="employeeinfo.jsp"/>
                    <%} else if (request.getAttribute("vipList") != null) {%>
